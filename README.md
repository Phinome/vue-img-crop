...
Simple Image Crop Component for Vue. Enables to crop a circle or a square out of an image.
...
`npm install vue-img-crop`

### Browser

Add the scripts to your application. Make sure the `ng-img-crop.js` file is inserted **after** the `vue.js` library:

```html
<script src="vue.js"></script>
<script src="vue-img-crop.js"></script>
<link rel="stylesheet" type="text/css" href="vue-img-crop.css">
```
